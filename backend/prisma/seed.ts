...
async function main() {
  ...
  // ==================== STUDENT FEES ====================
  // Generate fees for first student
  ...
  // Student 2 fees (sibling - should get sibling discount)
