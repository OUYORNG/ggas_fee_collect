...
let PaymentsController = class PaymentsController {
    ...
    findAll(studentId) { return this.service.findAll(studentId); }
    ...
    getTotalCollected(startDate, endDate) {
        return this.service.getTotalCollected(startDate ? new Date(startDate) : undefined, endDate ? new Date(endDate) : undefined);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PaymentsController.prototype, "findByReceipt", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PaymentsController.prototype, "getTotalCollected", null);
__decorate([
    (0, common_1.Get)(':id'),
